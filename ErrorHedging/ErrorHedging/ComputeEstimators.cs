...
namespace ErrorHedging
{
    static class ComputeEstimators
    {
        ...
        [DllImport(@"C:\Users\alexandre\Source\Repos\Projet.net2\ErrorHedging\wre-ensimag-c-4.1.dll", EntryPoint = "WREanalysisExpostVolatility", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(@"C:\Users\alexandre\Source\Repos\Projet.net2\ErrorHedging\wre-ensimag-c-4.1.dll", EntryPoint = "WREmodelingCorr", CallingConvention = CallingConvention.Cdecl)]
